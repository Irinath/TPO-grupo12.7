...
//   const terminos = document.getElementById('terminos');
//   if (campos.nombre && campos.apellido && campos.usuario && campos.documento && campos.contrasena && campos.correo && campos.cursoProgramacion && campos.cursoIdiomas && terminos.checked) {
//     formulario.reset();
